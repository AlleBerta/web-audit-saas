...
export const FilterBar = ({ onButtonClick, selectedButton, isLoading }: PropsFilterBar) => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg border border-gray-200">
      ...
      {/* Versione alternativa con tutti i bottoni che si dispongono su più righe */}
      <div className="hidden">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-2">
            <TargetsButton className="bg-blue-600 text-white hover:bg-blue-700 px-3 py-1 text-sm">
              📄 New 10
            </TargetsButton>
            <TargetsButton
              variant="outline"
              className="border-blue-600 text-blue-600 hover:bg-blue-50 px-3 py-1 text-sm"
            >
              🛡️ GDPR 12
            </TargetsButton>
            <TargetsButton
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <TargetsButton
              variant="outline"
              className="bg-green-500 text-white hover:bg-green-600 px-4 py-2 rounded"
              onClick={() => startAndPoll('http://example.com')}
            >
              Scan Now
            </TargetsButton>
            ...
            <TargetsButton
              variant="ghost"
              className="text-green-600 hover:bg-green-50 px-3 py-1 text-sm"
            >
              ➕ Add Target
            </TargetsButton>
